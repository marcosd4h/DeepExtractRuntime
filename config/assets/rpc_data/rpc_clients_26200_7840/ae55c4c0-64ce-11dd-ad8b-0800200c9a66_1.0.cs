...
namespace rpc_ae55c4c0_64ce_11dd_ad8b_0800200c9a66_1_0
{
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public int BdeSvcApipTakeFveAction(string p0, int p1, sbyte[] p2, int p3, ref sbyte[] p4, int p5, ref System.Nullable<int> p6, out int p7)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteReferent(p0, new System.Action<string>(m.WriteTerminatedString));
            m.WriteInt32(p1);
            m.WriteReferent(p2, new System.Action<sbyte[], long>(m.Write_0), p3);
            m.WriteInt32(p3);
