...
namespace rpc_8c7a6de0_788d_11d0_9edf_444553540000_2_0
{
    ...
    public struct Struct_3 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.WriteEmbeddedPointer<string>(Member20, new System.Action<string>(m.WriteBasicString));
            m.WriteInt32(Member28);
            m.WriteEmbeddedPointer<string>(Member30, new System.Action<string>(m.WriteBasicString));
        ...
        private void Unmarshal(_Unmarshal_Helper u)
        {
            ...
            Member20 = u.ReadEmbeddedPointer<string>(new System.Func<string>(u.ReadBasicString), false);
            Member28 = u.ReadInt32();
            Member30 = u.ReadEmbeddedPointer<string>(new System.Func<string>(u.ReadBasicString), false);
        ...
        public Struct_3(System.Guid Member0, string Member10, string Member18, string Member20, int Member28, string Member30, int Member38, Struct_5 Member3C)
        {
            this.Member0 = Member0;
            this.Member10 = Member10;
            this.Member18 = Member18;
    ...
    public struct Struct_6 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        public Struct_6(int Member0, System.Guid Member4, string Member18, NtApiDotNet.Ndr.Marshal.NdrUInt3264 Member20)
        {
            this.Member0 = Member0;
            this.Member4 = Member4;
            this.Member18 = Member18;
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.Write_9(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p0, "p0"), 1, 1);
        ...
        public int WiaGetRuntimetEventDataAsync(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, ref Struct_3[] p1)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.Write_9(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p1, "p1"), 1, 1);
