...
namespace rpc_25952c5d_7976_4aa1_a3cb_c35f7ae79d1b_1_1
{
    ...
    public struct Struct_4 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.Write_39(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(Member24, "Member24"));
            ...
            m.Write_4(Member23C);
            m.Write_6(Member540);
            m.WriteInt32(Member79C);
            m.Write_11(Member7A0);
            m.WriteInt32(Member7B4);
            m.WriteSByte(Member7B8);
            m.WriteInt32(Member7BC);
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
        ...
        private void Unmarshal(_Unmarshal_Helper u)
        {
            ...
            Member23C = u.Read_4();
            Member540 = u.Read_6();
            Member79C = u.ReadInt32();
            Member7A0 = u.Read_11();
            Member7B4 = u.ReadInt32();
            Member7B8 = u.ReadSByte();
            Member7BC = u.ReadInt32();
        }
        int NtApiDotNet.Ndr.Marshal.INdrStructure.GetAlignment()
        {
            return 4;
        ...
        public Struct_5 Member23C;
        public Struct_7 Member540;
        public int Member79C;
        public Struct_12 Member7A0;
        public int Member7B4;
        public sbyte Member7B8;
        public int Member7BC;
        public static Struct_4 CreateDefault()
        {
            Struct_4 ret = new Struct_4();
            ret.Member24 = new string('\0', 256);
            return ret;
        }
        public Struct_4(
                    System.Guid Member0, 
                    ...
                    int Member230, 
                    int Member234, 
                    NtApiDotNet.Ndr.Marshal.NdrEnum16 Member238, 
                    Struct_5 Member23C, 
                    Struct_7 Member540, 
                    int Member79C, 
                    Struct_12 Member7A0, 
                    ...
                    int Member7BC)
        {
            ...
            this.Member540 = Member540;
            this.Member79C = Member79C;
            this.Member7A0 = Member7A0;
            this.Member7B4 = Member7B4;
            this.Member7B8 = Member7B8;
            this.Member7BC = Member7BC;
        }
    }
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public int WDiagRpcInitSession(char p0, int p1, ref int p2, NtApiDotNet.Ndr.Marshal.NdrEnum16 p3, int p4, Struct_0 p5, out NtApiDotNet.Ndr.Marshal.NdrContextHandle p6)
        {
        ...
        public int WDiagRpcEndSession(ref NtApiDotNet.Ndr.Marshal.NdrContextHandle p0)
        {
            _Marshal_Helper m = new _Marshal_Helper();
        ...
        public int WDiagRpcQueryStatistics(char p0, out System.Nullable<Struct_2> p1)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteChar(p0);
        ...
        public int WDiagRpcQueryConnectionContextInfo(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, out System.Nullable<Struct_4> p1, out System.Nullable<Struct_15> p2, out System.Nullable<Struct_25> p3, out System.Nullable<Struct_36> p4)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
        ...
        public int WDiagRpcAutoConfigGetInterfaceInfo(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, out System.Nullable<Struct_4> p1)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
        ...
        public int WDiagRpcGetExtensibilityInfo(char p0, System.Guid p1, out System.Nullable<Struct_38> p2)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteChar(p0);
            m.WriteGuid(p1);
