...
namespace rpc_9b008953_f195_4bf9_bde0_4471971e58ed_1_0
{
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public uint SebiEnumerateEventsByType(string p0, int p1, int p2, out int p3, out System.Guid[] p4)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteReferent(p0, new System.Action<string>(m.WriteTerminatedString));
            m.WriteInt32(p1);
        ...
        public uint SebiQueryEventData(string p0, System.Guid p1, out Struct_1 p2)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteReferent(p0, new System.Action<string>(m.WriteTerminatedString));
            m.WriteGuid(p1);
        ...
        public uint SebiSignalSyncEventEx(string p0, System.Guid p1, int p2, int p3, sbyte[] p4, int p5, System.Nullable<System.Guid> p6, int p7, out NtApiDotNet.Ndr.Marshal.NdrEnum16 p8)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteReferent(p0, new System.Action<string>(m.WriteTerminatedString));
            m.WriteGuid(p1);
