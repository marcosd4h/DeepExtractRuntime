...
// Client Generated: 3/4/2026 7:38:01 PM
...
namespace rpc_e40f7b57_7a25_4cd3_a135_7f7d3df9d16b_1_0
{
    ...
    internal class _Marshal_Helper : NtApiDotNet.Ndr.Marshal.NdrMarshalBuffer
    {
        ...
        public void Write_18(Struct_6[] p0, long p1)
        {
        ...
        public void Write_20(long[] p0)
        {
            WriteFixedPrimitiveArray<long>(p0, 2);
        }
        public void Write_21(Struct_10[] p0, long p1)
        {
            WriteConformantStructArray<Struct_10>(p0, p1);
        }
        public void Write_22(Struct_12[] p0, long p1)
        {
    ...
    internal class _Unmarshal_Helper : NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer
    {
        ...
        public Struct_10[] Read_21()
        {
            return ReadConformantStructArray<Struct_10>();
        }
        public Struct_12[] Read_22()
        {
    ...
    public struct Struct_4 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.WriteInt32(Member4);
            m.WriteEmbeddedPointer<sbyte[], long>(Member8, new System.Action<sbyte[], long>(m.Write_16), Member0);
            m.WriteEmbeddedPointer<sbyte[], long>(Member10, new System.Action<sbyte[], long>(m.Write_17), Member4);
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
        ...
        private void Unmarshal(_Unmarshal_Helper u)
        {
            ...
            Member4 = u.ReadInt32();
            Member8 = u.ReadEmbeddedPointer<sbyte[]>(new System.Func<sbyte[]>(u.Read_16), false);
            Member10 = u.ReadEmbeddedPointer<sbyte[]>(new System.Func<sbyte[]>(u.Read_17), false);
        }
        int NtApiDotNet.Ndr.Marshal.INdrStructure.GetAlignment()
        {
            return 4;
    ...
    public struct Struct_7 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.WriteEmbeddedPointer<string[], long>(Member30, new System.Action<string[], long>(m.Write_19), Member28);
            m.WriteEmbeddedPointer<string[], long>(Member38, new System.Action<string[], long>(m.Write_19), Member28);
        ...
        private void Unmarshal(_Unmarshal_Helper u)
        {
            ...
            Member30 = u.ReadEmbeddedPointer<string[]>(new System.Func<string[]>(u.Read_19), false);
            Member38 = u.ReadEmbeddedPointer<string[]>(new System.Func<string[]>(u.Read_19), false);
    ...
    public struct Struct_11 : NtApiDotNet.Ndr.Marshal.INdrConformantStructure
    {
        ...
        {
            m.WriteInt32(Member0);
            m.Write_22(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(Member4, "Member4"), Member0);
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
    ...
    public struct Struct_12 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        {
            m.WriteGuid(Member0);
            m.Write_23(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(Member10, "Member10"));
    ...
    public struct Struct_14 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        public Struct_14(System.Guid Member0, System.Guid Member10, System.Guid Member20, System.Guid Member30, System.Guid Member40, System.Guid Member50, System.Guid Member60, System.Guid Member70, System.Guid Member80)
        {
            this.Member0 = Member0;
            this.Member10 = Member10;
            this.Member20 = Member20;
    ...
    public struct Struct_15 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        public Struct_15(long Member0, long Member8, long Member10, long Member18, long Member20, long Member28, long Member30, long Member38)
        {
            this.Member0 = Member0;
            this.Member8 = Member8;
            this.Member10 = Member10;
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public int RpcSrvCreateSession(char[] p0, int p1, sbyte p2, NtApiDotNet.Ndr.Marshal.NdrEnum16 p3, System.Guid p4, System.Guid p5, out NtApiDotNet.Ndr.Marshal.NdrContextHandle p6)
        {
            ...
            m.Write_25(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p0, "p0"), p1);
            m.WriteInt32(p1);
            m.WriteSByte(p2);
            m.WriteEnum16(p3);
            m.WriteGuid(p4);
        ...
        public int RpcSrvFirewallWcmAddAppRoutePolicyRules(string p0, string p1, Struct_14 p2, System.Guid p3, out Struct_15 p4)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteReferent(p0, new System.Action<string>(m.WriteTerminatedString));
            m.WriteReferent(p1, new System.Action<string>(m.WriteTerminatedString));
        ...
        public int RpcSrvFirewallWcmDeleteAppRoutePolicyRules(Struct_15 p0)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.Write_14(p0);
        ...
        public int RpcSrvFirewallWcmDeleteAppRoutePolicyRulesByProviderId(System.Guid p0)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteGuid(p0);
        ...
        public int RpcSrvFirewallWcmAddProvider(System.Guid p0, string p1, string p2)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteGuid(p0);
            m.WriteReferent(p1, new System.Action<string>(m.WriteTerminatedString));
        ...
        public int RpcSrvFirewallWcmDeleteProvider(System.Guid p0)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteGuid(p0);
