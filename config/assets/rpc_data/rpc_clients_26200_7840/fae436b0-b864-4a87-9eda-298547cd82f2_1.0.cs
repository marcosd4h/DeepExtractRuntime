...
namespace rpc_fae436b0_b864_4a87_9eda_298547cd82f2_1_0
{
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public uint HamRpcSrvDebugQueryPackageStateEx(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, long p1, out int p2, out Struct_1[] p3, out int p4)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteInt64(p1);
            ...
            p2 = u.ReadInt32();
            p3 = u.ReadReferent<Struct_1[]>(new System.Func<Struct_1[]>(u.Read_9), false);
            p4 = u.ReadInt32();
            return u.ReadUInt32();
        }
