...
namespace rpc_ff9fd3c4_742e_45e0_91dd_2f5bc632a1df_1_0
{
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        // async
        public int SetPackageStatusBlockingForUserImplementation(int p0, string[] p1, string p2, NtApiDotNet.Ndr.Marshal.NdrEnum16 p3)
        {
        ...
        public int Proc1(NtApiDotNet.Ndr.Marshal.NdrEnum16 p0, string p1, string p2, string[] p3, int p4, string p5, out System.Nullable<Struct_0> p6)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteEnum16(p0);
        ...
        public int AddToPurgeList(string p0, sbyte p1, int p2, string[] p3, out NtApiDotNet.NtEvent[] p4)
        {
            _Marshal_Helper m = new _Marshal_Helper();
