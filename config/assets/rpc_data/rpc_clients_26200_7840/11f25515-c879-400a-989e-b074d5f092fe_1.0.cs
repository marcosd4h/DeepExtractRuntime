...
// Client Generated: 3/4/2026 7:37:39 PM
...
namespace rpc_11f25515_c879_400a_989e_b074d5f092fe_1_0
{
    ...
    public struct Struct_1 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        public Struct_1(NtApiDotNet.Ndr.Marshal.NdrEnum16 Member0, int Member4, int[] Member8, int Member10)
        {
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public int RpcConnectTerminalEx(System.Nullable<System.Guid> p0)
        {
            _Marshal_Helper m = new _Marshal_Helper();
        ...
        public int RpcSystemShutdownStarted(int p0)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteInt32(p0);
        ...
        public int RpcGetRequestForWinlogon(ref NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, NtApiDotNet.Ndr.Marshal.NdrUInt3264 p1, out Struct_1 p2)
        {
            _Marshal_Helper m = new _Marshal_Helper();
        ...
        public int RpcReportWinlogonReply(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, Struct_2 p1)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.Write_1(p1);
        ...
        public int RpcCreateWorkerSession(byte[] p0, int p1, byte[] p2, int p3, int p4, Struct_2 p5, int p6, out int p7)
        {
            _Marshal_Helper m = new _Marshal_Helper();
        ...
        public int RpcGetWorkerSessionGpuLuid(int p0, out Struct_2 p1)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteInt32(p0);
