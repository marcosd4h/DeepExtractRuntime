...
namespace rpc_697dcda9_3ba9_4eb2_9247_e11f1901b0d2_1_0
{
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public uint CSebiCreatePrivateEvent(Struct_0 p0, out Struct_1 p1, out NtApiDotNet.Ndr.Marshal.NdrContextHandle p2)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.Write_0(p0);
        ...
        public uint CSebiDeleteEvent(Struct_1 p0, ref NtApiDotNet.Ndr.Marshal.NdrContextHandle p1)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.Write_1(p0);
