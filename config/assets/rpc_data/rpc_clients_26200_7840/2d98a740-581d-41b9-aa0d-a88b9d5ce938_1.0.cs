...
namespace rpc_2d98a740_581d_41b9_aa0d_a88b9d5ce938_1_0
{
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public uint RBiSrvPackageChangeState(int p0, int p1, byte[] p2, string p3, NtApiDotNet.Ndr.Marshal.NdrEnum16 p4)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteInt32(p0);
            m.WriteInt32(p1);
            m.Write_29(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p2, "p2"), p1);
        ...
        public uint RBiSrvQueryWorkItem(System.Guid p0, sbyte p1, out int p2, out byte[] p3)
        {
            ...
            p2 = u.ReadInt32();
            p3 = u.ReadReferent<byte[]>(new System.Func<byte[]>(u.Read_31), false);
            return u.ReadUInt32();
        }
        ...
        public uint RBiSrvSignalEvent(System.Guid p0, System.Nullable<sbyte> p1, System.Nullable<System.Guid> p2, byte[] p3, int p4, System.Nullable<System.Guid> p5)
        {
            ...
            m.WriteReferent(p3, new System.Action<byte[], long>(m.Write_32), p4);
            m.WriteInt32(p4);
        ...
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.Write_33(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p0, "p0"));
            m.WriteInt32(p1);
        ...
        public uint RBiSrvUpdateEventInformation(System.Guid p0, byte[] p1, int p2)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteGuid(p0);
            m.WriteReferent(p1, new System.Action<byte[], long>(m.Write_34), p2);
            m.WriteInt32(p2);
