...
namespace rpc_923c9623_db7f_4b34_9e6d_e86580f8ca2a_1_0
{
    ...
    internal class _Marshal_Helper : NtApiDotNet.Ndr.Marshal.NdrMarshalBuffer
    {
        ...
        public void Write_23(NtApiDotNet.NtEvent p0)
        {
    ...
    internal class _Unmarshal_Helper : NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer
    {
        ...
        public NtApiDotNet.NtEvent Read_23()
        {
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public int AccountsMgmtRpcConvertWebAccountIdFromAppSpecificId(int p0, string p1, out string p2)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteInt32(p0);
        ...
        public int AccountsMgmtRpcConvertWebAccountIdToAppSpecificId(int p0, string p1, out string p2)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteInt32(p0);
            m.WriteTerminatedString(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p1, "p1"));
        ...
        public int AccountsMgmtRpcDiscoverInternetMailServerConfig(System.Guid p0, string p1, out int p2, out byte[] p3, string p4)
        {
            ...
            p2 = u.ReadInt32();
            p3 = u.ReadReferent<byte[]>(new System.Func<byte[]>(u.Read_24), false);
            return u.ReadInt32();
        }
