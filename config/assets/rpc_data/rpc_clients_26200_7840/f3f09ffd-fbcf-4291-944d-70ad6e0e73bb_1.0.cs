...
namespace rpc_f3f09ffd_fbcf_4291_944d_70ad6e0e73bb_1_0
{
    ...
    public struct Struct_2 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.WriteEmbeddedPointer<sbyte[], long, long>(Member58, new System.Action<sbyte[], long, long>(m.Write_7), Member50, Member50);
        ...
        private void Unmarshal(_Unmarshal_Helper u)
        {
            ...
            Member58 = u.ReadEmbeddedPointer<sbyte[]>(new System.Func<sbyte[]>(u.Read_7), false);
    ...
    public struct Struct_4 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.WriteEmbeddedPointer<string>(Member18, new System.Action<string>(m.WriteTerminatedString));
            m.WriteEmbeddedPointer<string>(Member20, new System.Action<string>(m.WriteTerminatedString));
            m.WriteEmbeddedPointer<sbyte[], long>(Member28, new System.Action<sbyte[], long>(m.Write_8), Member30);
            ...
            m.WriteEmbeddedPointer<Struct_6>(Member60, new System.Action<Struct_6>(m.Write_5));
        ...
        private void Unmarshal(_Unmarshal_Helper u)
        {
            ...
            Member18 = u.ReadEmbeddedPointer<string>(new System.Func<string>(u.ReadConformantVaryingString), false);
            Member20 = u.ReadEmbeddedPointer<string>(new System.Func<string>(u.ReadConformantVaryingString), false);
            Member28 = u.ReadEmbeddedPointer<sbyte[]>(new System.Func<sbyte[]>(u.Read_8), false);
            ...
            Member60 = u.ReadEmbeddedPointer<Struct_6>(new System.Func<Struct_6>(u.Read_5), false);
        ...
        public NtApiDotNet.Ndr.Marshal.NdrEmbeddedPointer<Struct_6> Member60;
        public NtApiDotNet.Ndr.Marshal.NdrEmbeddedPointer<Struct_6> Member68;
        public static Struct_4 CreateDefault()
        {
            return new Struct_4();
        }
        public Struct_4(string Member0, string Member8, int Member10, string Member18, string Member20, sbyte[] Member28, int Member30, System.Nullable<System.Guid> Member38, string Member40, string Member48, string Member50, System.Nullable<System.Guid> Member58, System.Nullable<Struct_6> Member60, System.Nullable<Struct_6> Member68)
        {
            this.Member0 = Member0;
            this.Member8 = Member8;
            this.Member10 = Member10;
    ...
    public struct Struct_6 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            m.WriteEmbeddedPointer<string>(Member0, new System.Action<string>(m.WriteTerminatedString));
            m.WriteEmbeddedPointer<string>(Member8, new System.Action<string>(m.WriteTerminatedString));
            m.WriteEmbeddedPointer<sbyte[], long>(Member10, new System.Action<sbyte[], long>(m.Write_9), Member18);
        ...
        public Struct_6(string Member0, string Member8, sbyte[] Member10, int Member18, NtApiDotNet.Ndr.Marshal.NdrEnum16 Member1C)
        {
            this.Member0 = Member0;
            this.Member8 = Member8;
            this.Member10 = Member10;
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public int WluirDisplayTSDisconnectOptions(int p0, int[] p1, int p2, out int p3, out int p4)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteInt32(p0);
            m.Write_11(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p1, "p1"), p0);
            m.WriteInt32(p2);
        ...
        public int WluirPromptForCredentials(int p0, Struct_2 p1, Struct_4 p2, int p3, int p4, sbyte[] p5, int p6, int p7, int p8, out sbyte[] p9, out int p10, out int p11, out int p12, out int p13)
        {
            ...
            p9 = u.ReadReferent<sbyte[]>(new System.Func<sbyte[]>(u.Read_13), false);
            p10 = u.ReadInt32();
            p11 = u.ReadInt32();
            p12 = u.ReadInt32();
            p13 = u.ReadInt32();
        ...
        public int WluirRequestCredentials(int p0, NtApiDotNet.Ndr.Marshal.NdrEnum16 p1, System.Nullable<Struct_7> p2, string p3, out Struct_7 p4, ref System.Nullable<int> p5, out string p6, out string p7)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteInt32(p0);
            m.WriteEnum16(p1);
