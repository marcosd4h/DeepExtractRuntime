...
namespace rpc_e60c73e6_88f9_11cf_9af1_0020af6e72f4_2_0
{
    ...
    internal class _Marshal_Helper : NtApiDotNet.Ndr.Marshal.NdrMarshalBuffer
    {
        ...
        public void Write_12(System.Nullable<Struct_10>[] p0, long p1)
        {
            WriteConformantStructPointerArray<Struct_10>(p0, p1);
        }
        public void Write_13(byte[] p0, long p1)
        {
            WriteConformantArray<byte>(p0, p1);
        }
        public void Write_14(short[] p0, long p1)
        {
            WriteConformantArray<short>(p0, p1);
        }
        ...
        public void Write_16(short[] p0, long p1)
        {
            WriteConformantArray<short>(p0, p1);
        }
        ...
        public void Write_24(Struct_4[] p0, long p1)
        {
        ...
        public void Write_32(long[] p0, long p1, long p2)
        {
            WriteConformantVaryingArray<long>(p0, p1, p2);
        }
        public void Write_33(long[] p0, long p1)
        {
            WriteConformantArray<long>(p0, p1);
        }
    ...
    internal class _Unmarshal_Helper : NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer
    {
        ...
        public System.Nullable<Struct_10>[] Read_12()
        {
            return ReadConformantStructPointerArray<Struct_10>(false);
        }
        public byte[] Read_13()
        {
            return ReadConformantArray<byte>();
        }
        public short[] Read_14()
        {
            return ReadConformantArray<short>();
        }
        public long[] Read_15()
    ...
    public struct Struct_9 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            m.WriteInt32(Member0);
            m.WriteInt32(Member4);
            m.WriteEmbeddedPointer<System.Nullable<Struct_10>[], long>(Member8, new System.Action<System.Nullable<Struct_10>[], long>(m.Write_12), NtApiDotNet.Win32.Rpc.RpcUtils.OpBitwiseAnd(NtApiDotNet.Win32.Rpc.RpcUtils.OpPlus(Member0, 1), -2));
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
        ...
        private void Unmarshal(_Unmarshal_Helper u)
        {
            Member0 = u.ReadInt32();
            Member4 = u.ReadInt32();
            Member8 = u.ReadEmbeddedPointer<System.Nullable<Struct_10>[]>(new System.Func<System.Nullable<Struct_10>[]>(u.Read_12), false);
        }
        int NtApiDotNet.Ndr.Marshal.INdrStructure.GetAlignment()
        {
            return 4;
        ...
        public int Member0;
        public int Member4;
        public NtApiDotNet.Ndr.Marshal.NdrEmbeddedPointer<System.Nullable<Struct_10>[]> Member8;
        public static Struct_9 CreateDefault()
        {
            Struct_9 ret = new Struct_9();
            ret.Member8 = new System.Nullable<Struct_10>[0];
            return ret;
        }
    ...
    public struct Struct_10 : NtApiDotNet.Ndr.Marshal.INdrConformantStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.WriteInt32(Member4);
            m.WriteInt32(Member8);
            m.Write_13(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(MemberC, "MemberC"), NtApiDotNet.Win32.Rpc.RpcUtils.OpBitwiseAnd(NtApiDotNet.Win32.Rpc.RpcUtils.OpPlus(Member8, 7), -8));
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
    ...
    public struct Struct_11 : NtApiDotNet.Ndr.Marshal.INdrConformantStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            m.WriteInt32(Member0);
            m.WriteInt32(Member4);
            m.Write_14(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(Member8, "Member8"), Member4);
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public uint Connect(
                    ...
                    int p3, 
                    short p4, 
                    out NtApiDotNet.Ndr.Marshal.NdrContextHandle p5, 
                    out int p6, 
                    out System.Nullable<Struct_2> p7, 
                    out long p8, 
                    int p9, 
                    out long[] p10, 
                    out int p11, 
                    ...
                    out byte[] p30)
        {
            ...
            p6 = u.ReadInt32();
            p7 = u.ReadReferentValue<Struct_2>(new System.Func<Struct_2>(u.Read_1), false);
            p8 = u.ReadInt64();
            p10 = u.Read_15();
            p11 = u.ReadInt32();
            p12 = u.ReadInt32();
            ...
            p17 = u.ReadInt32();
            p18 = u.ReadInt32();
            p19 = u.ReadReferent<short[]>(new System.Func<short[]>(u.Read_16), false);
            p20 = u.ReadInt32();
            p21 = u.ReadReferent<Struct_3[]>(new System.Func<Struct_3[]>(u.Read_17), false);
            p22 = u.ReadInt32();
            p23 = u.ReadReferent<System.Guid[]>(new System.Func<System.Guid[]>(u.Read_18), false);
            p24 = u.ReadInt32();
            p25 = u.ReadInt32();
            p26 = u.ReadInt64();
            p27 = u.ReadGuid();
            p28 = u.Read_19();
            p29 = u.ReadInt32();
            p30 = u.ReadReferent<byte[]>(new System.Func<byte[]>(u.Read_20), false);
            return u.ReadUInt32();
        }
        ...
        public uint BulkUpdateOIDs(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, int p1, Struct_4[] p2, out int[] p3, int p4, Struct_4[] p5, int p6, long[] p7, int p8, long[] p9, int p10, Struct_5[] p11, int p12, Struct_5[] p13)
        {
            ...
            m.WriteContextHandle(p0);
            m.WriteInt32(p1);
            m.Write_24(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p2, "p2"), p1);
            m.WriteInt32(p4);
            m.Write_26(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p5, "p5"), p4);
            m.WriteInt32(p6);
            m.Write_27(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p7, "p7"), p6);
            m.WriteInt32(p8);
            m.Write_28(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p9, "p9"), p8);
            m.WriteInt32(p10);
            m.Write_29(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p11, "p11"), p10);
            m.WriteInt32(p12);
            m.Write_30(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p13, "p13"), p12);
            _Unmarshal_Helper u = SendReceive(4, m);
            p3 = u.Read_25();
            return u.ReadUInt32();
        }
        public uint ClientResolveOXID(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, long p1, System.Nullable<Struct_2> p2, out Struct_6 p3, out long p4, out int p5, out sbyte[] p6, out short p7)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteInt64(p1);
            ...
            p4 = u.ReadInt64();
            p5 = u.ReadInt32();
            p6 = u.ReadReferent<sbyte[]>(new System.Func<sbyte[]>(u.Read_31), false);
            p7 = u.ReadInt16();
            return u.ReadUInt32();
        }
        public uint ServerAllocateOXIDAndOIDs(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, out long p1, out long p2, int p3, out long[] p4, out int p5, Struct_6 p6, Struct_2 p7, Struct_2 p8, out long p9, out System.Nullable<Struct_2> p10)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteInt32(p3);
