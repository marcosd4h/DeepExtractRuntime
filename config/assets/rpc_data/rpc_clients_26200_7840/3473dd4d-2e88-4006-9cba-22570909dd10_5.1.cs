...
// Client Generated: 3/4/2026 7:38:51 PM
...
namespace rpc_3473dd4d_2e88_4006_9cba_22570909dd10_5_1
{
    ...
    internal class _Marshal_Helper : NtApiDotNet.Ndr.Marshal.NdrMarshalBuffer
    {
        ...
        public void Write_20(Struct_11[] p0, long p1)
        {
        ...
        public void Write_26(NtApiDotNet.NtFile p0)
        {
    ...
    internal class _Unmarshal_Helper : NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer
    {
        ...
        public NtApiDotNet.NtFile Read_26()
        {
    ...
    public struct Struct_3 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.WriteEmbeddedPointer<Struct_6[], long>(Member28, new System.Action<Struct_6[], long>(m.Write_15), Member24);
        ...
        private void Unmarshal(_Unmarshal_Helper u)
        {
            ...
            Member28 = u.ReadEmbeddedPointer<Struct_6[]>(new System.Func<Struct_6[]>(u.Read_15), false);
        ...
        public Struct_3(Struct_4 Member0, NtApiDotNet.Ndr.Marshal.NdrEnum16 Member20, int Member24, Struct_6[] Member28, int Member30)
        {
            this.Member0 = Member0;
    ...
    public struct Struct_4 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        public Struct_4(int Member0, Struct_5[] Member8, System.Nullable<int> Member10, int Member18)
        {
            this.Member0 = Member0;
            this.Member8 = Member8;
            this.Member10 = Member10;
    ...
    public struct Struct_5 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        public Struct_5(int Member0, int Member4, NtApiDotNet.Ndr.Marshal.NdrEnum16 Member8, string Member10, short Member18)
        {
            this.Member0 = Member0;
            this.Member4 = Member4;
            this.Member8 = Member8;
    ...
    public struct Struct_6 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        public Struct_6(Struct_4 Member0, NtApiDotNet.Ndr.Marshal.NdrEnum16 Member20)
        {
            this.Member0 = Member0;
            this.Member20 = Member20;
        }
    ...
    public struct Struct_7 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.WriteEmbeddedPointer<int[], long>(Member58, new System.Action<int[], long>(m.Write_17), Member54);
            m.WriteInt32(Member60);
            m.WriteEmbeddedPointer<Struct_9[], long>(Member68, new System.Action<Struct_9[], long>(m.Write_18), Member60);
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
        ...
        private void Unmarshal(_Unmarshal_Helper u)
        {
            ...
            Member58 = u.ReadEmbeddedPointer<int[]>(new System.Func<int[]>(u.Read_17), false);
            Member60 = u.ReadInt32();
            Member68 = u.ReadEmbeddedPointer<Struct_9[]>(new System.Func<Struct_9[]>(u.Read_18), false);
        }
        int NtApiDotNet.Ndr.Marshal.INdrStructure.GetAlignment()
        {
            return 4;
    ...
    public struct Struct_10 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            m.WriteEmbeddedPointer<Struct_11[], long>(Member0, new System.Action<Struct_11[], long>(m.Write_20), Member8);
            m.WriteInt32(Member8);
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
        ...
        private void Unmarshal(_Unmarshal_Helper u)
        {
            Member0 = u.ReadEmbeddedPointer<Struct_11[]>(new System.Func<Struct_11[]>(u.Read_20), false);
            Member8 = u.ReadInt32();
        }
        int NtApiDotNet.Ndr.Marshal.INdrStructure.GetAlignment()
        {
    ...
    public struct Struct_11 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        public Struct_11(string Member0, int Member8)
        {
            this.Member0 = Member0;
            this.Member8 = Member8;
        }
    ...
    public struct Struct_12 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            m.WriteEmbeddedPointer<Struct_13[], long>(Member0, new System.Action<Struct_13[], long>(m.Write_21), Member8);
            m.WriteInt32(Member8);
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
        ...
        private void Unmarshal(_Unmarshal_Helper u)
        {
            Member0 = u.ReadEmbeddedPointer<Struct_13[]>(new System.Func<Struct_13[]>(u.Read_21), false);
            Member8 = u.ReadInt32();
        }
        int NtApiDotNet.Ndr.Marshal.INdrStructure.GetAlignment()
        {
        ...
        public Struct_12(Struct_13[] Member0, int Member8)
        {
            this.Member0 = Member0;
            this.Member8 = Member8;
        }
    ...
    public struct Struct_13 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.WriteEmbeddedPointer<string>(Member8, new System.Action<string>(m.WriteTerminatedString));
            m.WriteInt32(Member10);
            m.WriteEmbeddedPointer<byte[], long>(Member18, new System.Action<byte[], long>(m.Write_22), Member10);
            m.WriteInt32(Member20);
            m.WriteEmbeddedPointer<string[], long>(Member28, new System.Action<string[], long>(m.Write_23), Member20);
            m.WriteInt32(Member30);
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
        ...
        private void Unmarshal(_Unmarshal_Helper u)
        {
            ...
            Member8 = u.ReadEmbeddedPointer<string>(new System.Func<string>(u.ReadConformantVaryingString), false);
            Member10 = u.ReadInt32();
            Member18 = u.ReadEmbeddedPointer<byte[]>(new System.Func<byte[]>(u.Read_22), false);
            Member20 = u.ReadInt32();
            Member28 = u.ReadEmbeddedPointer<string[]>(new System.Func<string[]>(u.Read_23), false);
            Member30 = u.ReadInt32();
        }
        int NtApiDotNet.Ndr.Marshal.INdrStructure.GetAlignment()
        {
        ...
        public Struct_13(string Member0, string Member8, int Member10, byte[] Member18, int Member20, string[] Member28, int Member30)
        {
            this.Member0 = Member0;
            this.Member8 = Member8;
            this.Member10 = Member10;
    ...
    public struct Struct_14 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.WriteEmbeddedPointer<string[], long>(Member30, new System.Action<string[], long>(m.Write_24), Member28);
            m.WriteInt32(Member38);
            m.WriteEmbeddedPointer<string>(Member40, new System.Action<string>(m.WriteTerminatedString));
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        ...
        private void Unmarshal(_Unmarshal_Helper u)
        {
            ...
            Member30 = u.ReadEmbeddedPointer<string[]>(new System.Func<string[]>(u.Read_24), false);
            Member38 = u.ReadInt32();
            Member40 = u.ReadEmbeddedPointer<string>(new System.Func<string>(u.ReadConformantVaryingString), false);
        }
        int NtApiDotNet.Ndr.Marshal.INdrStructure.GetAlignment()
        ...
        public Struct_14(long Member0, long Member8, string Member10, string Member18, string Member20, int Member28, string[] Member30, int Member38, string Member40)
        {
            this.Member0 = Member0;
            this.Member8 = Member8;
            this.Member10 = Member10;
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        // async
        public int GetProxyForUrl(Struct_0 p0, Struct_1 p1, Struct_2 p2, int p3, byte[] p4, out int p5, out Struct_3 p6, out NtApiDotNet.NtFile p7)
        {
            ...
            m.Write_2(p2);
            m.WriteInt32(p3);
            m.WriteReferent(p4, new System.Action<byte[], long>(m.Write_25), p3);
        ...
        public int ReadProxySettings(string p0, int p1, int p2, out int p3, out int p4, out Struct_7 p5)
        {
            _Marshal_Helper m = new _Marshal_Helper();
        ...
        public int WriteProxySettings(int p0, Struct_7 p1)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteInt32(p0);
            m.Write_7(p1);
        ...
        public int ConnectionUpdateIfIndexTable(Struct_10 p0)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.Write_10(p0);
        ...
        public int ConnectionSetPolicyEntries(int p0, Struct_12 p1)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteInt32(p0);
            m.Write_12(p1);
        ...
        // async
        public int GetProxySettingsEx(Struct_2 p0, int p1, long p2, string p3, string p4, out Struct_14 p5)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.Write_2(p0);
            m.WriteInt32(p1);
