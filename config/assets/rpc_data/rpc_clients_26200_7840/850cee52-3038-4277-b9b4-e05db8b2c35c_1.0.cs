...
namespace rpc_850cee52_3038_4277_b9b4_e05db8b2c35c_1_0
{
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        // async
        public int DasStartFinalize(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, out NtApiDotNet.Ndr.Marshal.NdrEnum16 p1)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
        ...
        public int DasGetAssociationSetAepIds(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, out int p1, out string[] p2, out int p3)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            _Unmarshal_Helper u = SendReceive(8, m);
            p1 = u.ReadInt32();
            p2 = u.ReadReferent<string[]>(new System.Func<string[]>(u.Read_12), false);
            p3 = u.ReadInt32();
            return u.ReadInt32();
        }
        public int DasCreateAssociationSetMemberContext(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, string p1, int p2, int p3, Struct_1[] p4, out NtApiDotNet.Ndr.Marshal.NdrContextHandle p5)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteTerminatedString(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p1, "p1"));
            m.WriteInt32(p2);
            m.WriteInt32(p3);
            m.WriteReferent(p4, new System.Action<Struct_1[], long>(m.Write_13), p3);
        ...
        public int DasStartAepExport(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, string p1, out int p2, out sbyte[] p3)
        {
            ...
            p2 = u.ReadInt32();
            p3 = u.ReadReferent<sbyte[]>(new System.Func<sbyte[]>(u.Read_15), false);
            return u.ReadInt32();
        }
