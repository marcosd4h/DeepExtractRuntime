...
namespace rpc_4f4fa786_2f8f_49e8_8aae_6669febd5d1d_1_0
{
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public int LuiApiDownloadServer(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, string p1, int p2, int p3, int p4, string p5, out int p6, int p7, string p8, NtApiDotNet.NtToken p9)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            ...
            m.WriteTerminatedString(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p5, "p5"));
            m.WriteInt32(p7);
            m.WriteReferent(p8, new System.Action<string>(m.Write_0));
            m.Write_1(p9);
