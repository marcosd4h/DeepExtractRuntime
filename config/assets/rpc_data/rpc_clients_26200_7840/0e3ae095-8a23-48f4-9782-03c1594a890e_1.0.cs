...
namespace rpc_0e3ae095_8a23_48f4_9782_03c1594a890e_1_0
{
    ...
    public struct Struct_1 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.WriteEmbeddedPointer<byte[], long>(Member10, new System.Action<byte[], long>(m.Write_6), Member18);
        ...
        public Struct_1(string Member0, int Member8, byte[] Member10, int Member18, Struct_2 Member20)
        {
            this.Member0 = Member0;
            this.Member8 = Member8;
            this.Member10 = Member10;
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        // async
        public int s_NgcKspSecretAgreement(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, NtApiDotNet.Ndr.Marshal.NdrContextHandle p1, out NtApiDotNet.Ndr.Marshal.NdrContextHandle p2, int p3)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
        ...
        // async
        public int s_NgcKspDeriveKey(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, string p1, System.Nullable<Struct_4> p2, ref byte[] p3, int p4, out int p5, int p6)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteTerminatedString(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p1, "p1"));
            m.WriteReferent(p2, new System.Action<Struct_4>(m.Write_4));
            m.WriteReferent(p3, new System.Action<byte[], long>(m.Write_14), p4);
            m.WriteInt32(p4);
            m.WriteInt32(p6);
            _Unmarshal_Helper u = SendReceive(18, m);
            p3 = u.ReadReferent<byte[]>(new System.Func<byte[]>(u.Read_14), false);
            p5 = u.ReadInt32();
            return u.ReadInt32();
        }
        // async
        public int s_NgcKspFreeSecret(ref NtApiDotNet.Ndr.Marshal.NdrContextHandle p0)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
        ...
        // async
        public int s_NgcKspAuthenticatedReqResp(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, byte[] p1, int p2, ref byte[] p3, int p4, out int p5, int p6)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.Write_11(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p1, "p1"), p2);
