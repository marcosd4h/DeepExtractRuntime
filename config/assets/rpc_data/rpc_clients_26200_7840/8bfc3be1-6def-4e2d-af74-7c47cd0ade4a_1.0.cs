...
namespace rpc_8bfc3be1_6def_4e2d_af74_7c47cd0ade4a_1_0
{
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public uint RBiSrvChangeApplicationStateForPackageNameForUser(byte[] p0, int p1, string p2, NtApiDotNet.Ndr.Marshal.NdrEnum16 p3, out sbyte p4)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteReferent(p0, new System.Action<byte[], long>(m.Write_0), p1);
            m.WriteInt32(p1);
        ...
        public uint RBiSrvNotifyNewUser(byte[] p0, int p1)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteReferent(p0, new System.Action<byte[], long>(m.Write_0), p1);
            m.WriteInt32(p1);
