...
namespace rpc_6ddfc7d1_7fca_44eb_a279_e9988f4db32b_1_0
{
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public int Server_AddDeviceToClientContext(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, int p1, string p2, int p3, int p4, byte[] p5, int p6, byte[] p7, out int p8, out long p9)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteInt32(p1);
            ...
            m.WriteInt32(p6);
            m.WriteReferent(p7, new System.Action<byte[], long>(m.Write_2), p6);
        ...
        public int Server_RequestMediaTypeChange(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, int p1, int p2, out long p3)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteInt32(p1);
        ...
        public int Server_RequestMediaTypeChangeComplete(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, long p1, int p2)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteInt64(p1);
        ...
        public int Server_LockVirtualCameraSessions(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, string p1, long p2)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
        ...
        public int Server_UnlockVirtualCameraSessions(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, string p1)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteTerminatedString(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p1, "p1"));
        ...
        public int Server_GetServiceMetadata(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, NtApiDotNet.Ndr.Marshal.NdrEnum16 p1, int p2, ref byte[] p3, out int p4)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteEnum16(p1);
            m.WriteInt32(p2);
            m.WriteReferent(p3, new System.Action<byte[], long>(m.Write_23), p2);
            _Unmarshal_Helper u = SendReceive(34, m);
            p3 = u.ReadReferent<byte[]>(new System.Func<byte[]>(u.Read_23), false);
            p4 = u.ReadInt32();
            return u.ReadInt32();
        }
        public int Server_SendServiceIoctl(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, int p1, int p2, byte[] p3, int p4, ref byte[] p5, out int p6)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteInt32(p1);
            m.WriteInt32(p2);
            m.WriteReferent(p3, new System.Action<byte[], long>(m.Write_24), p2);
            m.WriteInt32(p4);
            m.WriteReferent(p5, new System.Action<byte[], long>(m.Write_25), p4);
