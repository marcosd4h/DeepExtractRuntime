...
namespace rpc_0497b57d_2e66_424f_a0c6_157cd5d41700_1_0
{
    ...
    internal class _Marshal_Helper : NtApiDotNet.Ndr.Marshal.NdrMarshalBuffer
    {
        ...
        public void Write_6(NtApiDotNet.NtProcess p0)
        {
            WriteSystemHandle<NtApiDotNet.NtProcess>(p0);
        }
        public void Write_7(NtApiDotNet.NtThread p0)
        {
        ...
        public void Write_9(NtApiDotNet.NtProcess[] p0, long p1)
        {
            WriteConformantArrayCallback<NtApiDotNet.NtProcess>(p0, new System.Action<NtApiDotNet.NtProcess>(this.Write_8), p1);
        }
    }
    internal class _Unmarshal_Helper : NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer
    {
        ...
        public NtApiDotNet.NtProcess Read_6()
        {
            return ReadSystemHandle<NtApiDotNet.NtProcess>();
        }
        public NtApiDotNet.NtThread Read_7()
        {
        ...
        {
            return ReadConformantArrayCallback<NtApiDotNet.NtProcess>(new System.Func<NtApiDotNet.NtProcess>(this.Read_8));
        }
    }
    #endregion
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        // async
        public int RAiGetPackageActivationTokenForFilePath(string p0, NtApiDotNet.NtToken p1, out Struct_4 p2)
        {
            _Marshal_Helper m = new _Marshal_Helper();
        ...
        // async
        public int RAiGetPackageActivationTokenForAlias(string p0, NtApiDotNet.NtToken p1, out Struct_4 p2)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteTerminatedString(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p0, "p0"));
            m.Write_4(p1);
        ...
        // async
        public int RAiGetPackageActivationTokenForSxS(string p0, NtApiDotNet.NtToken p1, int p2, out Struct_4 p3)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteTerminatedString(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p0, "p0"));
            m.Write_4(p1);
        ...
        // async
        public int RAiCreateJitvSilo(string p0, out NtApiDotNet.Ndr.Marshal.NdrContextHandle p1)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteTerminatedString(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p0, "p0"));
        ...
        // async
        public int RAiCloseJitvSilo(ref NtApiDotNet.Ndr.Marshal.NdrContextHandle p0)
        {
            _Marshal_Helper m = new _Marshal_Helper();
        ...
        // async
        public int RAiGetProcessesFromJitvSilos(string p0, out int p1, out NtApiDotNet.NtProcess[] p2)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteTerminatedString(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p0, "p0"));
            _Unmarshal_Helper u = SendReceive(8, m);
            p1 = u.ReadInt32();
            p2 = u.ReadReferent<NtApiDotNet.NtProcess[]>(new System.Func<NtApiDotNet.NtProcess[]>(u.Read_9), false);
            return u.ReadInt32();
        }
    }
    #endregion
