...
namespace rpc_12345678_1234_abcd_ef00_0123456789ab_1_0
{
    ...
    internal class _Marshal_Helper : NtApiDotNet.Ndr.Marshal.NdrMarshalBuffer
    {
        ...
        public void Write_137(string[] p0, long p1)
        {
        ...
        public void Write_140(string[] p0, long p1)
        {
            WriteConformantStringArray(p0, new System.Action<string>(this.WriteTerminatedString), p1);
        }
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public int RpcPrintSupportOperation(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, int p1, int p2, sbyte[] p3, int p4, out int p5)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteInt32(p1);
        ...
        public int RpcIppCreateJobOnPrinter(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, int p1, string p2, int p3, sbyte[] p4, out int p5, out sbyte[] p6)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteInt32(p1);
            m.WriteReferent(p2, new System.Action<string>(m.WriteTerminatedString));
            m.WriteInt32(p3);
            m.Write_135(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p4, "p4"), p3);
            _Unmarshal_Helper u = SendReceive(119, m);
            p5 = u.ReadInt32();
            p6 = u.ReadReferent<sbyte[]>(new System.Func<sbyte[]>(u.Read_136), false);
            return u.ReadInt32();
        }
        public int RpcIppGetJobAttributes(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, int p1, int p2, string[] p3, out int p4, out sbyte[] p5)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteInt32(p1);
            m.WriteInt32(p2);
            m.Write_137(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p3, "p3"), p2);
            _Unmarshal_Helper u = SendReceive(120, m);
            p4 = u.ReadInt32();
            p5 = u.ReadReferent<sbyte[]>(new System.Func<sbyte[]>(u.Read_138), false);
            return u.ReadInt32();
        }
        public int RpcIppSetJobAttributes(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, int p1, int p2, sbyte[] p3, out int p4, out sbyte[] p5)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteInt32(p1);
            m.WriteInt32(p2);
            m.Write_139(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p3, "p3"), p2);
            _Unmarshal_Helper u = SendReceive(121, m);
            p4 = u.ReadInt32();
            p5 = u.ReadReferent<sbyte[]>(new System.Func<sbyte[]>(u.Read_138), false);
            return u.ReadInt32();
        }
        public int RpcIppGetPrinterAttributes(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, int p1, string[] p2, out int p3, out sbyte[] p4)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteInt32(p1);
            ...
            p3 = u.ReadInt32();
            p4 = u.ReadReferent<sbyte[]>(new System.Func<sbyte[]>(u.Read_141), false);
            return u.ReadInt32();
        }
        public int RpcIppSetPrinterAttributes(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, int p1, sbyte[] p2, out int p3, out sbyte[] p4)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteInt32(p1);
            m.Write_142(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p2, "p2"), p1);
            _Unmarshal_Helper u = SendReceive(123, m);
            p3 = u.ReadInt32();
            p4 = u.ReadReferent<sbyte[]>(new System.Func<sbyte[]>(u.Read_141), false);
            return u.ReadInt32();
        }
        public int RpcIppCreateJobOnPrinterWithAttributes(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, int p1, string p2, int p3, sbyte[] p4, int p5, sbyte[] p6, out int p7, out sbyte[] p8)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteInt32(p1);
            ...
            m.Write_135(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p4, "p4"), p3);
            m.WriteInt32(p5);
            m.Write_143(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p6, "p6"), p5);
            _Unmarshal_Helper u = SendReceive(124, m);
            p7 = u.ReadInt32();
            p8 = u.ReadReferent<sbyte[]>(new System.Func<sbyte[]>(u.Read_144), false);
            return u.ReadInt32();
        }
        public int RpcInstallPrinterDriverPackageFromConnection(string p0)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteTerminatedString(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p0, "p0"));
