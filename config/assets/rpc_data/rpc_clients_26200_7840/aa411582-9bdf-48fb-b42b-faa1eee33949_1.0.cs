...
namespace rpc_aa411582_9bdf_48fb_b42b_faa1eee33949_1_0
{
    ...
    internal class _Marshal_Helper : NtApiDotNet.Ndr.Marshal.NdrMarshalBuffer
    {
        ...
        public void Write_4(System.Nullable<Struct_3>[] p0, long p1, long p2)
        {
    ...
    internal class _Unmarshal_Helper : NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer
    {
        ...
        public System.Nullable<Struct_3>[] Read_4()
        {
            return ReadConformantVaryingStructPointerArray<Struct_3>(false);
        }
        public sbyte[] Read_5()
        {
    ...
    public struct Struct_2 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        {
            m.WriteInt16(Member0);
            m.WriteEmbeddedPointer<System.Nullable<Struct_3>[], long, long>(Member8, new System.Action<System.Nullable<Struct_3>[], long, long>(m.Write_4), Member0, Member0);
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
        ...
        {
            Member0 = u.ReadInt16();
            Member8 = u.ReadEmbeddedPointer<System.Nullable<Struct_3>[]>(new System.Func<System.Nullable<Struct_3>[]>(u.Read_4), false);
        }
        int NtApiDotNet.Ndr.Marshal.INdrStructure.GetAlignment()
        {
            return 4;
        ...
        public Struct_2(short Member0, System.Nullable<Struct_3>[] Member8)
        {
            this.Member0 = Member0;
            this.Member8 = Member8;
        }
    ...
    public struct Struct_3 : NtApiDotNet.Ndr.Marshal.INdrConformantStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.Write_5(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(MemberC, "MemberC"), Member8);
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
        ...
        public Struct_3(NtApiDotNet.Ndr.Marshal.NdrEnum16 Member0, NtApiDotNet.Ndr.Marshal.NdrEnum16 Member4, int Member8, sbyte[] MemberC)
        {
            this.Member0 = Member0;
            this.Member4 = Member4;
            this.Member8 = Member8;
