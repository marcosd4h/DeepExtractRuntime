...
// Client Generated: 3/4/2026 7:38:52 PM
...
namespace rpc_12e65dd8_887f_41ef_91bf_8d816c42c2e7_1_0
{
    ...
    public struct Struct_0 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.WriteEmbeddedPointer<sbyte[], long, long>(Member58, new System.Action<sbyte[], long, long>(m.Write_4), Member50, Member50);
        ...
        private void Unmarshal(_Unmarshal_Helper u)
        {
            ...
            Member58 = u.ReadEmbeddedPointer<sbyte[]>(new System.Func<sbyte[]>(u.Read_4), false);
    ...
    public struct Struct_2 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.WriteEmbeddedPointer<string>(Member18, new System.Action<string>(m.WriteTerminatedString));
            m.WriteEmbeddedPointer<string>(Member20, new System.Action<string>(m.WriteTerminatedString));
            m.WriteEmbeddedPointer<sbyte[], long>(Member28, new System.Action<sbyte[], long>(m.Write_5), Member30);
            ...
            m.WriteEmbeddedPointer<Struct_4>(Member60, new System.Action<Struct_4>(m.Write_3));
            m.WriteEmbeddedPointer<Struct_4>(Member68, new System.Action<Struct_4>(m.Write_3));
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
        ...
        private void Unmarshal(_Unmarshal_Helper u)
        {
            ...
            Member60 = u.ReadEmbeddedPointer<Struct_4>(new System.Func<Struct_4>(u.Read_3), false);
            Member68 = u.ReadEmbeddedPointer<Struct_4>(new System.Func<Struct_4>(u.Read_3), false);
        }
        int NtApiDotNet.Ndr.Marshal.INdrStructure.GetAlignment()
        {
            return 4;
        ...
        public NtApiDotNet.Ndr.Marshal.NdrEmbeddedPointer<Struct_4> Member60;
        public NtApiDotNet.Ndr.Marshal.NdrEmbeddedPointer<Struct_4> Member68;
        public static Struct_2 CreateDefault()
        {
            return new Struct_2();
        }
        public Struct_2(string Member0, string Member8, int Member10, string Member18, string Member20, sbyte[] Member28, int Member30, System.Nullable<System.Guid> Member38, string Member40, string Member48, string Member50, System.Nullable<System.Guid> Member58, System.Nullable<Struct_4> Member60, System.Nullable<Struct_4> Member68)
        {
            this.Member0 = Member0;
            this.Member8 = Member8;
            this.Member10 = Member10;
    ...
    public struct Struct_4 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            m.WriteEmbeddedPointer<string>(Member0, new System.Action<string>(m.WriteTerminatedString));
            m.WriteEmbeddedPointer<string>(Member8, new System.Action<string>(m.WriteTerminatedString));
            m.WriteEmbeddedPointer<sbyte[], long>(Member10, new System.Action<sbyte[], long>(m.Write_6), Member18);
        ...
        private void Unmarshal(_Unmarshal_Helper u)
        {
            Member0 = u.ReadEmbeddedPointer<string>(new System.Func<string>(u.ReadConformantVaryingString), false);
            Member8 = u.ReadEmbeddedPointer<string>(new System.Func<string>(u.ReadConformantVaryingString), false);
            Member10 = u.ReadEmbeddedPointer<sbyte[]>(new System.Func<sbyte[]>(u.Read_6), false);
        ...
        public Struct_4(string Member0, string Member8, sbyte[] Member10, int Member18, NtApiDotNet.Ndr.Marshal.NdrEnum16 Member1C)
        {
            this.Member0 = Member0;
            this.Member8 = Member8;
            this.Member10 = Member10;
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public int WlSecureDesktoprPromptingRequest(int p0, Struct_0 p1, Struct_2 p2, int p3, int p4, sbyte[] p5, int p6, int p7, int p8, out sbyte[] p9, out int p10, out int p11, out int p12, ref int p13)
        {
            ...
            m.WriteInt32(p3);
            m.WriteInt32(p4);
            m.WriteReferent(p5, new System.Action<sbyte[], long>(m.Write_7), p6);
            m.WriteInt32(p6);
            m.WriteInt32(p7);
            m.WriteInt32(p8);
            m.WriteInt32(p13);
            _Unmarshal_Helper u = SendReceive(0, m);
            p9 = u.ReadReferent<sbyte[]>(new System.Func<sbyte[]>(u.Read_8), false);
            p10 = u.ReadInt32();
            p11 = u.ReadInt32();
            p12 = u.ReadInt32();
            p13 = u.ReadInt32();
        ...
        public int WlSecureDesktoprConfirmationRequest(string p0, int p1, int p2, int p3, out char[] p4, out int p5, out sbyte[] p6, out int p7)
        {
            ...
            p4 = u.ReadReferent<char[]>(new System.Func<char[]>(u.Read_9), false);
            p5 = u.ReadInt32();
            p6 = u.ReadReferent<sbyte[]>(new System.Func<sbyte[]>(u.Read_10), false);
            p7 = u.ReadInt32();
            return u.ReadInt32();
        }
        // async
