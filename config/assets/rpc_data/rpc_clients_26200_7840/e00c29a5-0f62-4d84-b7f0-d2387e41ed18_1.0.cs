...
namespace rpc_e00c29a5_0f62_4d84_b7f0_d2387e41ed18_1_0
{
    ...
    public struct Struct_3 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.Write_10(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(Member42, "Member42"));
            m.WriteEnum16(MemberC4);
            m.WriteEnum16(MemberC8);
            m.WriteEnum16(MemberCC);
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
        ...
        private void Unmarshal(_Unmarshal_Helper u)
        {
            ...
            MemberC8 = u.ReadEnum16();
            MemberCC = u.ReadEnum16();
        }
        int NtApiDotNet.Ndr.Marshal.INdrStructure.GetAlignment()
        {
            return 2;
        ...
        public NtApiDotNet.Ndr.Marshal.NdrEnum16 MemberC8;
        public NtApiDotNet.Ndr.Marshal.NdrEnum16 MemberCC;
        ...
        public Struct_3(string Member0, string Member42, NtApiDotNet.Ndr.Marshal.NdrEnum16 MemberC4, NtApiDotNet.Ndr.Marshal.NdrEnum16 MemberC8, NtApiDotNet.Ndr.Marshal.NdrEnum16 MemberCC)
        {
            this.Member0 = Member0;
    ...
    public struct Struct_4 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        public Struct_4(NtApiDotNet.Ndr.Marshal.NdrEnum16 Member0, Struct_5 Member4)
        {
            this.Member0 = Member0;
            this.Member4 = Member4;
        }
    ...
    public struct Struct_5 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        public Struct_5(Struct_6 Member0)
        {
            this.Member0 = Member0;
        }
    }
    public struct Struct_6 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        public Struct_6(string Member0, string Member42, NtApiDotNet.Ndr.Marshal.NdrEnum16 MemberC4, NtApiDotNet.Ndr.Marshal.NdrEnum16 MemberC8)
        {
            this.Member0 = Member0;
            this.Member42 = Member42;
            this.MemberC4 = MemberC4;
    ...
    public struct Struct_7 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        {
            m.Write_7(Member0);
            m.Write_11(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(Member6, "Member6"));
            m.Write_12(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(Member62, "Member62"));
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
        ...
        public Struct_7(Struct_8 Member0, string Member6, string Member62)
        {
            this.Member0 = Member0;
    ...
    public struct Struct_9 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.Write_14(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(Member8, "Member8"));
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
        ...
        public Struct_9(int Member0, int Member4, string Member8)
        {
            this.Member0 = Member0;
            this.Member4 = Member4;
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public int TetheringSvcStartSharing(System.Nullable<System.Guid> p0, System.Nullable<System.Guid> p1, System.Nullable<Struct_1> p2, int p3)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteReferent(p0, new System.Action<System.Guid>(m.WriteGuid));
        ...
        public int TetheringSvcGetConfiguration(System.Nullable<System.Guid> p0, ref System.Nullable<Struct_4> p1, ref System.Nullable<Struct_4> p2, out int p3)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteReferent(p0, new System.Action<System.Guid>(m.WriteGuid));
        ...
        public int TetheringSvcSetConfiguration(System.Nullable<System.Guid> p0, System.Nullable<Struct_4> p1, System.Nullable<Struct_4> p2, int p3)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteReferent(p0, new System.Action<System.Guid>(m.WriteGuid));
            m.WriteReferent(p1, new System.Action<Struct_4>(m.Write_3));
        ...
        public int TetheringSvcGetPeerList(System.Nullable<System.Guid> p0, out int p1, out Struct_7[] p2)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteReferent(p0, new System.Action<System.Guid>(m.WriteGuid));
            _Unmarshal_Helper u = SendReceive(7, m);
            p1 = u.ReadInt32();
            p2 = u.ReadReferent<Struct_7[]>(new System.Func<Struct_7[]>(u.Read_15), false);
            return u.ReadInt32();
        }
        ...
        public int TetheringSvcAuthorize(System.Nullable<System.Guid> p0, Struct_9 p1)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteReferent(p0, new System.Action<System.Guid>(m.WriteGuid));
            m.Write_8(p1);
