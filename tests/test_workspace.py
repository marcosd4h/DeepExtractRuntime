...
def test_get_workspace_root():
    ...
    # explorer_output/.claude/skills/test/scripts/test.py
    # parents[4] should be explorer_output
    
    # This test file is at .claude/tests/test_workspace.py
    # parents[2] is workspace root
    root_path = Path(__file__).resolve().parents[2]
    fake_skill_script = root_path / ".claude" / "skills" / "test" / "scripts" / "test.py"
