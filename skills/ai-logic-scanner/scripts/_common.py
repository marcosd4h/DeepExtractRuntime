"""Shared utilities for the ai-logic-scanner skill.
...
NOT import API taxonomy lists, taint analysis, or scoring models -- all
vulnerability detection decisions are made by the LLM agent, not by
programmatic pattern matching.

Hint-generator scripts (scan_logic_flaws.py, scan_api_misuse.py) use
_hint_common.py instead of this module.
"""
