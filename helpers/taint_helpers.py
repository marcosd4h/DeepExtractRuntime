"""Taint enrichment helper library for AI-driven taint analysis.

Provides structured-data helpers for sink/source classification, severity
scoring, cross-module trust boundary detection, COM vtable resolution, RPC
boundary identification, and parameter inference.  All helpers consume
structured data (IPC indexes, DB exports/imports, outbound xrefs) rather
than regex-parsing decompiled code, making them suitable for the AI-driven
taint scanner pipeline.
"""
